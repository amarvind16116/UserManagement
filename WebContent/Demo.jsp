...
<%@page import="org.jboss.security.auth.spi.DatabaseServerLoginModule"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
		...
		PreparedStatement psmt = dbService.graphMaleData();
		...
		PreparedStatement psmt1 = dbService.graphMaleData();
